      ...
      <div className="border-2 rounded-2xl shadow-md p-6">
        ...
        <div>
          ...
          <div className="flex py-1">
            <h1 className="text-black font-semibold text-xl whitespace-nowrap">Current Level:</h1>
            <p className="text-gray-600 font-medium  text-xl dark:text-dark-6 pl-2">
              {currentLevel}
            </p>
          </div>
          <div className="flex py-1">
            <h1 className="text-black font-semibold text-xl  whitespace-nowrap">Total Capacity:</h1>
            <p className="text-gray-600 font-medium  text-xl dark:text-dark-6 pl-2">
              {totalCapacity}
            </p>
          </div>
          <div className="flex py-1">
            <h1 className="text-black text-xl font-semibold whitespace-nowrap">Location:</h1>
